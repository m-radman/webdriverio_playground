...
describe("Login tests (with PO)", () => {
  ...
  it("user should be able to login successfully with valid credentials", async () => {
    ...
    // await FlashMessage.waitForSuccessMessage()
    // const isPresent = await FlashMessage.isSuccessMessagePresentInDOM()
    // const textMessage = await FlashMessage.getTextFromSuccesMessage()
